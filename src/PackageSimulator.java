...
public class PackageSimulator {
    ...
    public String getSimulationInfo() {
        ...
        for (int i = 0; i < packages.size(); i++) {
            simInfo += packages.get(i).getOrigin().toString() + "\n";
            simInfo += packages.get(i).getDestination().toString() + "\n";
            simInfo += "Weight: " + packages.get(i).getWeight() + "\n";
            simInfo += "Weight: " + packages.get(i).getHeight() + "\n";
            simInfo += "Weight: " + packages.get(i).getLength() + "\n";
            simInfo += "Weight: " + packages.get(i).getWidth() + "\n";
